        ...
        <div class="mb-18">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 gy-10">
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Paul Miles</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Jania Garnbet</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">James Nilson</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Mia Miles</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Sophia Miles</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Oliver Lucas</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Amelia Miles</a>
                ...
                <div class="col text-center mb-9">
                    ...
                    <div class="mb-0">
                        <a href="../../demo37/dist/pages/user-profile/projects.html" class="text-dark fw-bold text-hover-primary fs-3">Liam James</a>
                        <div class="text-muted fs-6 fw-semibold">QA Managers</div>
                    </div>
                </div>
            </div>
